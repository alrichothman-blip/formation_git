  ...
  async function handleSubmit() {
    ...
    try {
      await auth.register({
        ...
        password: form.password, sexe: form.sexe, nationalite: form.nationalite,
      ...
      setSaving(false);
      const msg = e.message || '';
      showToast('error', msg.includes('already') ? 'Cet e-mail est déjà inscrit. Connectez-vous.' : 'Erreur: ' + msg);
    }
  }
